...
public class DriverUtil {
    ...
    // no one can be able to create object from this class
    because we are making constructor private
     */
    private DriverUtil() {
    }
    ...
    public static WebDriver getDriver() {
        //We want to make sure there is no browser type defined on browser
        if (driver == null) {
